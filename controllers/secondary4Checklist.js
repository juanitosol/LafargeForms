...
module.exports.postSecondary4Checklist = async (req, res) => {
    ...
    const defectives = {
        ...
        d4077: d4077, d2007: d2007, d2010: d2010,
    ...
    const guards = {
        ...
        g4077: g4077, g2007: g2007, g2010: g2010,
        ...
        resource: {
            values: [
                [date, employee, shift,
                    ...
                    gt4047, gt4118, gt4077, gt2007, gt2010,
    ...
    const prefixes = [
        ...
        '1744077', '1442007', '1442010', '1442025',
        '1742023', '1442270'
    ]
